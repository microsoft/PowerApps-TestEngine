...
- Make use of the "Download suite" button available in Test Studio to download the converted test plan. Choose the test suite to convert if you have multiple test suites. ![Screenshot of Test Studio download test suite button](docs/images/downloadtestsuite.png)
