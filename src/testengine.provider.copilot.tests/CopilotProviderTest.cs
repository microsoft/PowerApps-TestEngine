...
{
    public class CopilotProviderTest
    {
        ...
        {
            // Arrange
            var provider = new CopilotProvider(MockTestInfraFunctions.Object, MockSingleTestInstanceState.Object, MockTestState.Object);
