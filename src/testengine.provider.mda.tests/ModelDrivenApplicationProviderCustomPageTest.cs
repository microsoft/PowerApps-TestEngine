...
namespace Microsoft.PowerApps.TestEngine.Tests.PowerApps
{
    public class ModelDrivenApplicationProviderCustomPageTests
    {
        ...
        [InlineData("getControlProperties", "mockPageType='custom';PowerAppsModelDrivenCanvas.isArray(JSON.parse(PowerAppsTestEngine.getControlProperties('TextInput1')))", true)]
