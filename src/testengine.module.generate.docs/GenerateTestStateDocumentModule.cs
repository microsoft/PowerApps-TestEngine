...
namespace testengine.module
{
    ...
    public class GenerateTestStateDocumentModule : ITestEngineModule
    {
        ...
        public void RegisterPowerFxFunction(PowerFxConfig config, ITestInfraFunctions testInfraFunctions, ITestWebProvider testWebProvider, ISingleTestInstanceState singleTestInstanceState, ITestState testState, IFileSystem fileSystem)
        {
            ...
            config.AddFunction(new GenerateTestStateDocumentFunction(testInfraFunctions, testState, logger, config));
            logger.LogInformation("Registered GenerateTestStateDocumentFunction()");
        }
