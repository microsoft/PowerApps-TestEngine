...
var PowerAppsTestEngine = {
     ...
     parseControl: function(controlName, controlObject) {
        var propertiesList = [];
     ...
     buildControlObjectModel: function() {
     ...
     getBindingContext: function(itemPath) {
     ...
     getPropertyValueFromControl: function(itemPath) {
