...
namespace Microsoft.PowerApps.TestEngine.Tests.PowerFx.Functions
{
    public class SetPropertyFunctionTests
    {
        ...
        {
            MockTestWebProvider.Setup(x => x.SetPropertyAsync(It.IsAny<ItemPath>(), It.IsAny<StringValue>())).Returns(Task.FromResult(false));
            ...
            MockTestWebProvider.Verify(x => x.SetPropertyAsync(It.Is<ItemPath>((item) => item.ControlName == recordValue.Name), It.Is<StringValue>(stringVal => stringVal.Value == "5")), Times.Once());
        ...
        public void SetPropertyStringFunctionTest()
        {
            ...
            Assert.IsType<BooleanValue>(result);
            MockTestWebProvider.Verify(x => x.SetPropertyAsync(It.Is<ItemPath>((item) => item.ControlName == recordValue.Name), It.Is<StringValue>(stringVal => stringVal.Value == "10")), Times.Once());
            ...
            Assert.IsType<BooleanValue>(result);
            MockTestWebProvider.Verify(x => x.SetPropertyAsync(It.Is<ItemPath>((item) => item.ControlName == recordValue.Name), It.Is<StringValue>(stringVal => stringVal.Value == "abc")), Times.Once());
        }

        [Fact]
        public void SetPropertyNumberFunctionTest()
        {
            MockTestWebProvider.Setup(x => x.SetPropertyAsync(It.IsAny<ItemPath>(), It.IsAny<NumberValue>())).Returns(Task.FromResult(true));
            LoggingTestHelper.SetupMock(MockLogger);
            ...
            Assert.IsType<BooleanValue>(result);
            MockTestWebProvider.Verify(x => x.SetPropertyAsync(It.Is<ItemPath>((item) => item.ControlName == recordValue.Name), It.Is<NumberValue>(numVal => numVal.Value == 5)), Times.Once());
        }

        [Fact]
        public void SetPropertyBooleanFunctionTest()
        {
            MockTestWebProvider.Setup(x => x.SetPropertyAsync(It.IsAny<ItemPath>(), It.IsAny<BooleanValue>())).Returns(Task.FromResult(true));
            LoggingTestHelper.SetupMock(MockLogger);
            ...
            Assert.IsType<BooleanValue>(result);
            MockTestWebProvider.Verify(x => x.SetPropertyAsync(It.Is<ItemPath>((item) => item.ControlName == recordValue.Name), It.Is<BooleanValue>(boolVal => boolVal.Value == true)), Times.Once());
        }

        [Fact]
        public void SetPropertyDateFunctionTest()
        {
            MockTestWebProvider.Setup(x => x.SetPropertyAsync(It.IsAny<ItemPath>(), It.IsAny<DateValue>())).Returns(Task.FromResult(true));
            LoggingTestHelper.SetupMock(MockLogger);
            ...
            Assert.IsType<BooleanValue>(result);
            MockTestWebProvider.Verify(x => x.SetPropertyAsync(It.Is<ItemPath>((item) => item.ControlName == recordValue.Name), It.Is<DateValue>(dateVal => dateVal.GetConvertedValue(null) == dt)), Times.Once());
        }

        [Fact]
        public void SetPropertyRecordFunctionTest()
        {
            MockTestWebProvider.Setup(x => x.SetPropertyAsync(It.IsAny<ItemPath>(), It.IsAny<RecordValue>())).Returns(Task.FromResult(true));
            LoggingTestHelper.SetupMock(MockLogger);
            ...
            Assert.IsType<BooleanValue>(result);
            MockTestWebProvider.Verify(x => x.SetPropertyAsync(It.Is<ItemPath>((item) => item.ControlName == recordValue.Name), It.Is<RecordValue>(recordVal => ((StringValue)recordVal.GetField("Value")).Value == "2")), Times.Once());
        }
        ...
        {
            MockTestWebProvider.Setup(x => x.SetPropertyAsync(It.IsAny<ItemPath>(), It.IsAny<TableValue>())).Returns(Task.FromResult(true));
            MockTestWebProvider.Setup(x => x.GetItemCount(It.IsAny<ItemPath>())).Returns(2);
            LoggingTestHelper.SetupMock(MockLogger);
            ...
            MockTestWebProvider.Verify(x => x.SetPropertyAsync(It.Is<ItemPath>((item) => item.ControlName == recordValue.Name), It.Is<TableValue>(tableVal => tableVal.Count() == 2)), Times.Once());
        }
    }
}
