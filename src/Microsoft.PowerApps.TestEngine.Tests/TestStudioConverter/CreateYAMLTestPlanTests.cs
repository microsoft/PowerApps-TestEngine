...
namespace Microsoft.PowerApps.TestEngine.Tests.TestStudioConverter
{
    public class CreateYAMLTestPlanTests
    {
        ...
        [Fact]
        public void ExtraTestStepsFromJsonTest()
        {
            var testJson = @"{
    ""TopParent"": {
        ""Type"": ""ControlInfo"",
        ...
        ""Children"": [
            ...
            List<string> testSteps = new List<string>(new string[] { 
            ...
            Assert.Equal(testSteps, converter.GetTestSteps());
        }

        [Fact]
        public void CheckIfValidYamlTest()
        {
