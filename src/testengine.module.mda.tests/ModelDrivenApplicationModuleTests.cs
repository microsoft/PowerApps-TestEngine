...
{
    public class ModelDrivenApplicationModuleTests
    {
        ...
        public ModelDrivenApplicationModuleTests()
        {
        ...
        {
            // Arrange
            var module = new ModelDrivenApplicationModule();
            ...
            MockLogger.Verify(l => l.Log(It.Is<LogLevel>(l => l == LogLevel.Information),
                It.IsAny<EventId>(),
                It.Is<It.IsAnyType>((v, t) => v.ToString() == "Registered ConsentDialog()"),
                It.IsAny<Exception>(),
